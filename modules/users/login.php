            ...
            if (!empty($password)) {
                ...
                if ($checkStatus) {
                    ...
                    if ($insert_Token) {
                        ...
                        redirect('?module=index&action=index');
                    } else {
    ...
    <div class="login-card">
        ...
        <form class="login-form" id="loginForm" novalidate method="POST" enctype="multipart/form-data">
            ...
            <div class="form-options">
                <a href="<?php echo _HOST_URL . "/?module=users&action=forgotpass" ?>" class="forgot-password">Quên mật
                    khẩu?</a>
            </div>
        ...
        <div class="signup-link">
            <p>Bạn chưa có tài khoản? <a href="<?php echo _HOST_URL . "/?module=users&action=register" ?>"
