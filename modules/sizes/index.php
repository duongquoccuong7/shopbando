<?php
layout('/dashboard/header', 'Danh sách size giày');
...
if (isGet()) {
    ...
    if (!empty($keyword)) {
        ...
        $chuoiwhere .= "(sizes.name LIKE '%$keyword%')";
    }
}
...
$getDetail = getAll(" SELECT * FROM  sizes  $chuoiwhere ORDER BY created_at DESC LIMIT $offset, $perPage");
//Xử lý query 
...
<div class="main-wrap">
    ...
    <div class="content-menu">
        <div class="title-list">
            <h2><?php echo  !empty($msg) ? getMess($msg, $msg_type) : 'List Size' ?></h2>
            <form action="" method="GET">
                <input type="hidden" name="module" value="sizes">
            ...
            <a style="text-decoration: none;" href="<?php echo _HOST_URL . "/?module=sizes&action=add" ?>"
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="8" class="text-center" style="font-weight: 500;"><?php echo "Không có kích thước"; ?>
                    </td>
                </tr>
                <?php endif; ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-list">
                            <a href="?module=sizes&action=edit&id=<?php echo $item['id'] ?>" class="btn-edit"><i
                                    class="fa-regular fa-pen-to-square"></i></a>
                            <a href="?module=sizes&action=delete&id=<?php echo $item['id'] ?>" class="btn-delete"
